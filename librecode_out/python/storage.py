"""
Storage and path utilities: librecode dir resolution, chat file
...
def get_librecode_dir() -> str:
    possible_paths = [
        "/data/data/com.librecode.app/files/storage_dir.txt",
