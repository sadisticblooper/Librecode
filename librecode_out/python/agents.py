...
# ── Paths ──────────────────────────────────────────────────────────────
# Bundled prompts live inside librecode_out/prompts/ (two levels up from this file)
_BUNDLED_PROMPTS = os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
    "prompts",
)

# Bundled providers live inside librecode_out/python/providers/ (sibling of this file)
...
# ── Fallback constants ─────────────────────────────────────────────────
_DEFAULT_SYSTEM_MD = (
    "You are a coding assistant running on a mobile Android app called LibreCode.\n\n"
...
def get_prompts_dir() -> str:
    from python.storage import get_librecode_dir
...
def get_providers_dir() -> str:
    from python.storage import get_librecode_dir
    local_providers = os.path.join(get_librecode_dir(), "providers")
