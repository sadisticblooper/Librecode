...
import com.librecode.app.mediator.MediatorBridgePoller;
import com.librecode.app.mediator.MediatorWebView;
...
import com.librecode.app.BrowserService;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (storageFolderPath == null || storageFolderPath.isEmpty()) {
            ...
            storageFolderPath = new File(extStorage, "librecode").getAbsolutePath();
        }
